...
const SEARCH_DATA = [
  ...
  {type:'palette',id:'p21',name:'어스 & 테라코타',mood:'편안·자연',harmony:'analogous',colors:['#FFF3E2','#E8C39E','#C68B59','#A15C38','#5C3D2E'],url:'palettes.html'},
  {type:'palette',id:'p22',name:'선샤인 옐로우',mood:'밝음·경쾌',harmony:'monochromatic',colors:['#FFFBEA','#FFE066','#FFC300','#E3A008','#8C6A00'],url:'palettes.html'},
  {type:'palette',id:'p23',name:'그레이스케일',mood:'미니멀·모던',harmony:'monochromatic',colors:['#FAFAFA','#D4D4D8','#9CA3AF','#52525B','#18181B'],url:'palettes.html'},
  {type:'palette',id:'p24',name:'레인보우 팝',mood:'다채로움·유쾌',harmony:'tetradic',colors:['#FF3355','#FFB627','#3DDC97','#3A86FF'],url:'palettes.html'},
  {type:'palette',id:'p25',name:'네온 시티',mood:'미래·강렬',harmony:'tetradic',colors:['#FF00E5','#00F0FF','#FFEA00','#7B2FFF'],url:'palettes.html'},
  {type:'palette',id:'p26',name:'선셋 오키드',mood:'몽환·따뜻',harmony:'split',colors:['#2B0B3F','#FF6F91','#FFB86B','#5AC8C8'],url:'palettes.html'},
